...
## 1. TABLEAU_I_ABC_TRADE (POSトランザクション)
...
|----|---:|---:|---:|---:|
| ホーム＆レジャー | 14 | 345 | 4,485 | 2,610,400 |
| ファッション | 11 | 216 | 2,808 | 1,500,902 |
| コスメ | 5 | 144 | 1,862 | 1,024,748 |
| フード＆ドリンク | 4 | 125 | 1,620 | 779,188 |
| デイリーグッズ | 3 | 88 | 1,144 | 621,712 |
| ホームエレクトロニクス | 2 | 36 | 468 | 267,930 |
| フレッシュミート | 4 | 38 | 487 | 195,120 |
...
| minor / brand / maker / item | - | TABLEAU_I_ABC_TRADE (直接) | ~10-30秒 |
| 任意 + 会員フィルタ | - | TABLEAU_I_ABC_TRADE (直接) | ~10-30秒 |
| 任意 + 小分類フィルタ | - | TABLEAU_I_ABC_TRADE (直接) | ~10-30秒 |
