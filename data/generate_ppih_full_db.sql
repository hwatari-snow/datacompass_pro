...
-- DT2: Daily × Store × Category summary (serves ABC and area analysis)
CREATE OR REPLACE DYNAMIC TABLE PPIH_FULL_DB.ANALYTICS.DT_DAILY_CATEGORY_STORE
  TARGET_LAG = '1 hour'
  WAREHOUSE = COMPUTE_WH
AS
SELECT
  ...
  i.MINOR_CODE, i.MINOR_NAME,
  i.BRAND_CODE, i.BRAND_NAME,
  i.MAKER_CODE, i.MAKER_NAME,
  SUM(t.ITEM_SALES_AMOUNT) AS TOTAL_SALES_AMOUNT,
  SUM(t.ITEM_SALES_QUANTITY) AS TOTAL_SALES_QUANTITY,
  COUNT(DISTINCT t.TRADE_KEY) AS RECEIPT_COUNT,
  COUNT(DISTINCT t.MAJICA_NO) AS MEMBER_COUNT
...
GROUP BY t.BUSINESS_DATE, t.STORE_CODE, t.TRADE_CLASS_3,
         ...
         i.MIDDLE_CODE, i.MIDDLE_NAME, i.MINOR_CODE, i.MINOR_NAME,
         i.BRAND_CODE, i.BRAND_NAME, i.MAKER_CODE, i.MAKER_NAME;
